#ifndef HOSTINTERFACERN_H
#define HOSTINTERFACERN_H
...
typedef struct
{
    ...
    // 0: Indicates an invalid slot such as the last slot in a Slot Map.
    // 1: Indicates a Range slot used for a normal range request – response transaction.
